...
class TestConversationListApi:
    ...
    def test_post_success(self, mock_conversation, mock_request, conversation_list_api, sample_conversation_object):
...
class TestConversationRetrievalApi:
    ...
    @patch('tangerine.resources.conversation.request')
    @patch('tangerine.resources.conversation.Conversation')
    def test_post_success(self, mock_conversation, mock_request, conversation_retrieval_api, sample_conversation_object):
        ...
        assert status_code == 200
        assert response == sample_conversation_object.to_json()
        mock_conversation.get_by_session.assert_called_once_with("12345678-1234-5678-9012-123456789012")
...
class TestConversationUpsertApi:
    ...
    @patch('tangerine.resources.conversation.request')
    @patch('tangerine.resources.conversation.Conversation')
    def test_post_success(self, mock_conversation, mock_request, conversation_upsert_api, sample_conversation_object):
...
class TestConversationDeleteApi:
    ...
    def test_post_success(self, mock_conversation, mock_request, conversation_delete_api):
        ...
        mock_conversation.delete_by_session.return_value = (True, "Conversation deleted successfully")
    ...
    def test_post_unauthorized(self, mock_conversation, mock_request, conversation_delete_api):
        ...
        mock_conversation.delete_by_session.return_value = (
            False, "Unauthorized: You can only delete your own conversations"
        )
    ...
    @patch('tangerine.resources.conversation.request')
    @patch('tangerine.resources.conversation.Conversation')
    def test_post_status_code_mapping(self, mock_conversation, mock_request, conversation_delete_api):
