...
class TestConversationModel:
    ...
    def test_get_by_session_found(self, mock_db_session, sample_conversation_object):
        ...
        with patch.object(Conversation, 'query', mock_query):
            ...
            mock_query.filter_by.assert_called_once_with(session_id="12345678-1234-5678-9012-123456789012")
    ...
    @patch('tangerine.models.conversation.db.session')
    def test_upsert_existing_conversation_same_user(self, mock_db_session, sample_conversation_json, sample_conversation_object):
    ...
    @patch('tangerine.models.conversation.db.session')
    def test_upsert_existing_conversation_different_user(self, mock_db_session, sample_conversation_json, sample_conversation_object):
